...
@NamedQueries({
	...
	@NamedQuery(name ="Fabricante.buscarPorCodigo", query= "SELECT fabricante FROM Fabricante fabricante WHERE codigo = :codigo ")
})
public class Fabricante implements Serializable {
	private static final long serialVersionUID = 6347216266766403487L;
	...
	@Size(min =1 , max=50 , message="Campo descrição necessita informar entre 1 e 50 Caracteres" )
